...
export default class LayerSearchStrategy extends LayerStrategy {
    #formSearch
    #resultSearch
    #output
    ...
    constructor(layerElement) {
        super(layerElement)
        this.#formSearch = this._layerElement.querySelector('form')
        this.#resultSearch = this._layerElement.querySelector('#resultSearch')
